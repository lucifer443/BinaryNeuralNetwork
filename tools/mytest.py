...
def main():
    ...
    cfg.model.backbone.Expand_num = -1.101
    ...
    # plt.figure()
    # plt.title('x-1.1')
    # plt.plot(np.arange(-20/10, 10/10,0.1),accu)
    # plt.grid()
    # plt.savefig('/workspace/S/jiangfei/BinaryNeuralNetwork_debug/tools/plot/x-1.1_E75.jpg')
    #print(accu)

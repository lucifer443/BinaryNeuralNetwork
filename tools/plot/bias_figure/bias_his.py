...
def main():
    ...
    parser.add_argument('--config', help='Config file',default='configs/baseline/rprelu_group/react_a/256react_x-0.75scb_step1.py')
    parser.add_argument('--checkpoint', help='checkpoint file',default='work_dirs/rprelu/react_a/256react_x-0.75scb_step1/latest.pth')
    parser.add_argument(

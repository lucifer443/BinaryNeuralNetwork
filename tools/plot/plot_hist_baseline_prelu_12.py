...
def main():
    ...
    config = 'configs/zzp/baseline/baseline_prelu/baseline_prelu_12_b32x8/baseline_prelu_12_b32x8_step1.py'
    ckpt = 'work_dir/baseline/baseline_prelu/baseline_prelu_12_b32x8/baseline_prelu_12_b32x8_step1/epoch_75.pth'
    ...
    for i in range(16):
        ...
        axs[i+16].grid()
        axs[i+32].set_title(f'bn_out_{i}')
        axs[i+32].hist(bn_out[i].flatten().numpy(), bins=100, alpha=0.7)
        axs[i+32].grid()
        ...
        axs[i+64].grid()
    fig.savefig('./work_dir/plot/feature_hist/feature_hist_baseline_prelu_12.jpg')

...
from .binary_utils.rprelu_block import RANetBlockB,RANetBlockC,RANetBlockD,RANetBlockE
...
class MobilebsArch(nn.Module):
    ...
    def __init__(self,
                 ...
                 sgbias = [0,0,0,0,0],
                 **kwargs):
        super(MobilebsArch, self).__init__()
    ...
    def train(self, mode=True):
        super(MobilebsArch, self).train(mode)
        self._freeze_stages()

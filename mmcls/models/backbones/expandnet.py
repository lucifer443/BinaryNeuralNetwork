...
from .binary_utils.expand_blocks import ExpandBlock
...
class ExpandArch(BaseBackbone):

    arch_settings = {
        "Expandnet": (ExpandBlock, (2, 2, 2, 2)),
    }
    ...
    def __init__(self,
        ...
        super(ExpandArch, self).__init__()
...
#             print(x.shape)
    ...
    def train(self, mode=True):
        super(ExpandArch, self).train(mode)
        self._freeze_stages()

...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={
            ...
            '.adbias1': dict(lr_mult=0.0,lr_add=1e-3,decay_mult=0.0),
            '.adbias2': dict(lr_mult=0.0,lr_add=1e-3,decay_mult=0.0),
...
work_dir = 'work_dirs/rprelu/react_a1/adreact_try+-0.05_0fe-3_step1'

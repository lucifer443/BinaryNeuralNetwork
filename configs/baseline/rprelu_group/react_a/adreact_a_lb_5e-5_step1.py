...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={
            ...
            '.adbias1': dict(lr_mult=0.0,lr_add=2e-5,decay_mult=0.0),
            '.adbias2': dict(lr_mult=0.0,lr_add=2e-5,decay_mult=0.0),
...
work_dir = 'work_dirs/rprelu/react_a1/adreact_3t1_0f2e-5_step1'

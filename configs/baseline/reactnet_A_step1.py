...
model = dict(
    ...
    distill=dict(
        ...
        teacher_ckpt='/lustre/S/jiangfei/BinaryNeuralNetwork/workdir/resnet34_batch256_imagenet_20200708-32ffb4f7.pth',
        loss_weight=1.,
        only_kdloss=True))
...
work_dir = '/lustre/S/jiangfei/BinaryNeuralNetwork/workdir/react_A_1028/base_s1'
